...
define('WORKFORCE_SETTINGS_FILE', 'workforce_settings.json');
define('STAFF_REQUESTS_FILE', 'staff_requests.json');
define('AUDIT_SETTINGS_FILE', 'audit_settings.json');
define('AUDIT_EVENTS_FILE', 'audit_events.json');
